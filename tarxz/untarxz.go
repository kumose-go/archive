...
// ExtractTarXZ extracts a .tar.xz archive to dest directory.
// Options control whether to strip the top-level directory and overwrite existing files.
func ExtractTarXZ(src, dest string, opts config.ExtractOptions) error {
